...
def train(model, train_loader, validation_loader, criterion, optimizer, args, device):
    '''
...
def main(args):
    ...
    # Log the learning rate and the batch size
    ...
    '''    
    train(model, train_loader, validation_loader, criterion, optimizer, args, device)    
